...
def initPosts():
    ...
    with app.app_context():
        ...
        posts = [
            Post(title='', comment='Hello! Welcome to the chatroom!', user_id=1, channel_id=1),
            Post(title='', comment='This is a collaborative place to discuss!', user_id=1, channel_id=1),
        ]
